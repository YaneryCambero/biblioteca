...
--
-- Table structure for table `estadosistema`
--
...
--
-- Dumping data for table `estadosistema`
--

LOCK TABLES `estadosistema` WRITE;
/*!40000 ALTER TABLE `estadosistema` DISABLE KEYS */;
/*!40000 ALTER TABLE `estadosistema` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-05-05 11:41:50
